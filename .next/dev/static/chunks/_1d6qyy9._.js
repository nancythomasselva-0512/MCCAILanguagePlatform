...
;
;
const clientId = ("TURBOPACK compile-time value", "692829825984-89f38mt3ojt7ff9gf0hkef5kh2h14rep.apps.googleusercontent.com") || '692829825984-89f38mt3ojt7ff9gf0hkef5kh2h14rep.apps.googleusercontent.com';
...
const AppProvider = ({ children })=>{
    ...
    const [theme, setTheme] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AppProvider.useState": ()=>{
            const saved = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getItem('mcc-ai-theme');
            if (saved === 'light' || saved === 'dark') return saved;
            return 'light';
        }
    }["AppProvider.useState"]);
    const [globalConfig, setGlobalConfig] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [billingOverview, setBillingOverview] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const fetchBillingOverview = async ()=>{
        const savedToken = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getItem('mcc-ai-token');
        if (!savedToken) {
            setBillingOverview(null);
            return;
        }
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/billing/tenant/overview");
    ...
    const loadGlobalConfig = async ()=>{
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/platform-builder/global-config");
            if (data) {
    ...
    const [contentFontFamily, setContentFontFamilyState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AppProvider.useState": ()=>{
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getItem('mcc-ai-content-font') || 'TAU-Marutham';
        }
    }["AppProvider.useState"]);
    const setContentFontFamily = (font)=>{
        setContentFontFamilyState(font);
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].setItem('mcc-ai-content-font', font);
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppProvider.useEffect": ()=>{
            const root = document.documentElement;
    ...
    const [activeTab, setActiveTabState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AppProvider.useState": ()=>{
            const savedTab = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getItem('mcc-ai-active-tab');
            const path = ("TURBOPACK compile-time truthy", 1) ? window.location.pathname : "TURBOPACK unreachable";
            ...
            const savedUser = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getItem('mcc-ai-user');
    ...
    const setActiveTab = (tab)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].setItem('mcc-ai-active-tab', tab);
    };
    ...
    const [history, setHistory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AppProvider.useState": ()=>{
            const saved = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getItem('mcc-ai-history');
    ...
    const fetchHistoryFromServer = async ()=>{
        ...
        try {
            const [transRes, ttsRes, audioRes] = await Promise.allSettled([
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/tools/history/translations"),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/tools/history/tts"),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/tools/history/transcriptions")
            ]);
            let combined = [];
            if (transRes.status === 'fulfilled' && transRes.value) {
                const items = transRes.value.map((item)=>({
                        id: item.id,
                        type: 'translation',
            ...
            if (ttsRes.status === 'fulfilled' && ttsRes.value) {
                const items = ttsRes.value.map((item)=>({
                        id: item.id,
                        type: 'text-to-speech',
            ...
            if (audioRes.status === 'fulfilled' && audioRes.value) {
                const items = audioRes.value.map((item)=>({
                        id: item.id,
            ...
            const finalItems = combined.map(({ raw_date, ...rest })=>rest);
            setHistory((prev)=>{
    ...
    // Provider states
    const [ttsProvider, setTtsProviderState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AppProvider.useState": ()=>{
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getItem('mcc-ai-tts-provider') || 'openai';
        }
    }["AppProvider.useState"]);
    const [audioSttProvider, setAudioSttProviderState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AppProvider.useState": ()=>{
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getItem('mcc-ai-audiostt-provider') || 'openai';
        }
    }["AppProvider.useState"]);
    const [transcriptionProvider, setTranscriptionProviderState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AppProvider.useState": ()=>{
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getItem('mcc-ai-transcription-provider') || 'openai';
        }
    }["AppProvider.useState"]);
    const [translationProvider, setTranslationProviderState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AppProvider.useState": ()=>{
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getItem('mcc-ai-translation-provider') || 'openai';
        }
    }["AppProvider.useState"]);
    ...
    const setTtsProvider = (provider)=>{
        setTtsProviderState(provider);
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].setItem('mcc-ai-tts-provider', provider);
    };
    const setAudioSttProvider = (provider)=>{
        setAudioSttProviderState(provider);
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].setItem('mcc-ai-audiostt-provider', provider);
    };
    const setTranscriptionProvider = (provider)=>{
        setTranscriptionProviderState(provider);
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].setItem('mcc-ai-transcription-provider', provider);
    };
    const setTranslationProvider = (provider)=>{
        setTranslationProviderState(provider);
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].setItem('mcc-ai-translation-provider', provider);
    };
    // Auth States
    ...
    const [token, setTokenState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AppProvider.useState": ()=>{
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getItem('mcc-ai-token');
        }
    }["AppProvider.useState"]);
    const [tenantSlug, setTenantSlugState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AppProvider.useState": ()=>{
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getItem('mcc-ai-tenant-slug');
        }
    }["AppProvider.useState"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppProvider.useEffect": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].setItem('mcc-ai-theme', theme);
    ...
    const [openAiApiKey, setOpenAiApiKeyState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AppProvider.useState": ()=>{
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getItem('mcc-ai-openai-key') || '';
        }
    }["AppProvider.useState"]);
    ...
    const setOpenAiApiKey = (key)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].setItem('mcc-ai-openai-key', key);
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppProvider.useEffect": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].setItem('mcc-ai-history', JSON.stringify(history));
        }
    }["AppProvider.useEffect"], [
        history
    ]);
    ...
    const addHistoryItem = (type, title, details, content)=>{
        const newItem = {
    ...
    // Auth Handlers
    const login = (name, email, role, token, refreshToken, slug)=>{
        const profile = {
            id: Math.random().toString(36).substring(2, 9),
            name,
            email,
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].setItem('mcc-ai-user', JSON.stringify(profile));
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].setItem('mcc-ai-token', token);
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].setItem('mcc-ai-refresh-token', refreshToken);
        if (slug) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].setItem('mcc-ai-tenant-slug', slug);
            // Also write to raw key to ensure it's accessible from any path
            localStorage.setItem('mcc-ai-tenant-slug', slug);
        } else {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].removeItem('mcc-ai-tenant-slug');
    ...
    const logout = ()=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].removeItem('mcc-ai-user');
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].removeItem('mcc-ai-token');
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].removeItem('mcc-ai-refresh-token');
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].removeItem('mcc-ai-tenant-slug');
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].removeItem('mcc-ai-active-tab');
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].removeItem('mcc-ai-sidebar-expanded');
        localStorage.removeItem('mcc-ai-tenant-slug');
        setHistory([]);
...
_s(AppProvider, "UV5lc/MIAPPkK7lZxMb5GH6VgEM=");
_c = AppProvider;
const useApp = ()=>{
    _s1();
...
async function apiRequest(endpoint, options = {}) {
    const token = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getItem("mcc-ai-token");
    let tenantSlug = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getItem("mcc-ai-tenant-slug");
    if (!tenantSlug) {
        try {
...
const isAdminPath = ()=>("TURBOPACK compile-time value", "object") !== "undefined" && window.location.pathname.startsWith("/admin");
...
const storage = {
    getItem: (key)=>{
        if (("TURBOPACK compile-time value", "object") === "undefined" || typeof localStorage === "undefined") return null;
...
//# sourceMappingURL=_1d6qyy9._.js.map