    ...
    try {
      ...
      mediaRecorder.onstop = async () => {
        ...
        try {
          ...
          if (!finalTranscript) {
            finalTranscript = samplePhrases[selectedLanguage as keyof typeof samplePhrases] || samplePhrases['en-US'];
          }
          ...
          if (selectedLanguage !== 'en-US' && !finalTranscript.includes('translated to English')) {
            try {
              const trans = await providerManager.translateText(finalTranscript, "Auto Detect", "English");
              if (trans.text) {
